...
namespace Backend.DataBase.Migrations
{
    ...
    [Migration("20250605074916_DeleteCreatedAtPropertyInPlayers")]
    partial class DeleteCreatedAtPropertyInPlayers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Entities.GameResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Backend.Entities.PlayerScore", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Backend.Entities.GameResult", b =>
                {
                    ...
                    b.HasOne("Backend.Entities.Playlist", "Playlist")
                        .WithOne()
                        .HasForeignKey("Backend.Entities.GameResult", "PlaylistId")
                    ...
                    b.HasOne("Backend.Entities.User", "Winner")
                        .WithMany()
            ...
            modelBuilder.Entity("Backend.Entities.PlayerScore", b =>
                {
                    b.HasOne("Backend.Entities.GameResult", "GameResult")
